<?php 
 ...
 //    $query = "INSERT INTO pendidikan(nama_sd, tahun_sd, nama_smp, tahun_smp, nama_sma, tahun_sma, nama_univ, tahun_univ) VALUES('$nama_sd','$tahun_sd','$nama_smp','$tahun_smp', '$nama_sma', '$tahun_sma', '$nama_univ', '$tahun_univ')";
